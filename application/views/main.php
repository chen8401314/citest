...
<body class="fixed-sidebar full-height-layout gray-bg"
		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						<div class="dropdown profile-element">
							<span><img alt="image" class="img-circle"
								src="res/img/profile_small.jpg" /></span> <a data-toggle="dropdown"
					...
					<li><a href="#"> <i class="fa fa-home"></i> <span class="nav-label">主页</span>
							<span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="index.php/manager/index" data-index="0">测试示例</a>
							</li>
					...
					<li><a href="#"><i class="fa fa-flask"></i> <span class="nav-label">UI元素</span><span
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="#">字体图标 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
									<li><a class="J_menuItem" href="fontawesome.html">Font Awesome</a>
									</li>
							...
							<li><a href="#">树形视图 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
									...
									<li><a class="J_menuItem" href="tree_view.html">Bootstrap Tree
											View</a></li>
					...
					<li><a class="J_menuItem" href="css_animation.html"><i
							class="fa fa-magic"></i> <span class="nav-label">CSS动画</span></a>
					</li>
			...
			<div class="row border-bottom">
				<nav class="navbar navbar-static-top" role="navigation"
					...
					<ul class="nav navbar-top-links navbar-right">
								...
								<li class="m-t-xs">
									<div class="dropdown-messages-box">
										...
										<div class="media-body">
											...
											这个在日本投降书上签字的军官，建国后一定是个不小的干部吧？ <br> <small class="text-muted">3天前
												2014.11.8</small>
										</div>
									</div>
								</li>
						...
						<li class="hidden-xs"><a href="index_v1.html" class="J_menuItem"
							data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a></li>
					...
					<div id="tab-1" class="tab-pane active">
						...
						<div class="skin-setttings">
							...
							<div class="setings-item yellow-skin nb">
								<span class="skin-name "> <a href="#" class="s-skin-3"> 黄色/紫色主题
								</a>
								</span>
							</div>
						</div>
	...
	<!-- 自定义js -->
	<script src="res/js/hplus.js?v=4.1.0"></script>
